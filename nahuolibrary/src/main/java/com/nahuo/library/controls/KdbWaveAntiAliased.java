 ...
 *
 */
public class KdbWaveAntiAliased extends View {
	...
	public KdbWaveAntiAliased(Context context) {
		this(context, null);
	}

	public KdbWaveAntiAliased(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public KdbWaveAntiAliased(Context context, AttributeSet attrs, int defStyleAttr) {
