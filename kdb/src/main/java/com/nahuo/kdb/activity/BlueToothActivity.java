...
import com.nahuo.kdb.adapter.BlueToolAdapter;
import com.nahuo.kdb.common.ListUtils;

import java.util.ArrayList;
import java.util.List;

import static com.nahuo.kdb.activity.BluetoothDeviceList.EXTRA_DEVICE_ADDRESS;
import static com.nahuo.kdb.activity.BluetoothDeviceList.EXTRA_DEVICE_NAME;
...
//                    messageBox("Please use Gprinter!");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Vthis = this;
            database = new PortParamDataBase1(this);
            registerBroadcast();
            connection();
