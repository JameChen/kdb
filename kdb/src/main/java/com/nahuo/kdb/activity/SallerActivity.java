...
import com.nahuo.kdb.ShopCartActivity;
import com.nahuo.kdb.ViewHub;
import com.nahuo.kdb.adapter.SallerAdapter;
...
public class SallerActivity extends AppCompatActivity  implements View.OnClickListener{
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                try {
                    ...
                    if (sellerUsersBean!=null){
                        ...
                        Intent intent=new Intent(SallerActivity.this, ShopCartActivity.class);
