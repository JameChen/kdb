...
import com.nahuo.kdb.exceptions.CatchedException;
...
public class ShareHelper {
    ...
    /* 微信 */
    private static final String WECHAT_APP_ID = Const.WeChatOpen.APP_ID;

    //微信小程序分享id
    private static final String WECHAT_MINIAPP_ID=Const.WECHAT_MINIAPP_IDS;
    ...
    public void wechatFriendShare(final ShareEntity share) {
        Log.v("ShareHelper",share.getTitle());
        Log.v("ShareHelper",share.getSummary());
        Log.v("ShareHelper",share.getImgUrl());
        Log.v("ShareHelper",share.getTargetUrl());
...
//        }
    ...
    private SendMessageToWX.Req getWechatWebReq(ShareEntity share, boolean toWxTimeLine) {
