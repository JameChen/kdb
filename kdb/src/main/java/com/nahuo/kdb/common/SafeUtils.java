...
public class SafeUtils {
     ...
     * @author ZZB
     */
    public static TreeMap<String, Object> genCommonSinParams(Context context, TreeMap<String, Object> params){
     ...
     * @author ZZB
     */
    public static TreeMap<String, Object> genPaySignParamsForPinHuo(Context context, TreeMap<String, Object> params,String time_stamp,String nonce) {
     ...
     * @author ZZB
     */
    public static TreeMap<String, Object> genPaySignParams(Context context, TreeMap<String, Object> params,
                                                           boolean addUserName) {
        params.put("partner", Const.WeChatOpen.PARTNER_ID);
        if (addUserName) {
    ...
    private static String genCommonSign(Map<String, Object> params) {
        return genSign(params, COMMON_SING_KEY);
    }
    private static String genPaySign(Map<String, Object> params) {
     ...
     * @author ZZB
     */
    private static String genSign(Map<String, Object> params, String signKey) {
        String tmp = "";
        try {
