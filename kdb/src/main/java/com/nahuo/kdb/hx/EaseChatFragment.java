...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toNickName= fragmentArgs.getString(EaseConstant.EXTRA_USER_NICK);
...
//        messageList.setAvatarShape(1);
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
            ...
            if (message.getChatType() == ChatType.GroupChat || message.getChatType() == ChatType.ChatRoom) {
                ...
                try {
                  String ss=  message.getStringAttribute("nick");
                    Log.d("yu",ss);
    ...
    protected void sendMessage(EMMessage message){
        ...
        message.setAttribute(EaseConstant.EXTRA_USER_NICK, SpManager.getShopName(BWApplication.getInstance()));
        if(chatFragmentHelper != null){
            //set extension
