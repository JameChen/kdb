...
import com.nahuo.kdb.utils.ToastUtil;
...
public class ViewHub {
    ...
    public static void showExitDialog(final Context context) {
        ...
        // Builder builder = LoginAlertDialog.Builder.create(context);
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                if (context instanceof Activity) {
                    FunctionHelper.hideSoftInput((Activity)context);
                }
...
//
    ...
    public static void showShortToast(Context context, String text) {
        ToastUtil.getInstance(context).showShortToast(text);
