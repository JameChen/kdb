package com.nahuo.kdb.controls.dslv;
...
/**
 * @description 拖拽listview
 * @created 2015-3-11 下午3:29:08
 * @author heycosmo
 * @credit https://github.com/bauerca/drag-sort-listview
 */
public class DragSortListView extends ListView {
    
    private boolean mFirstItemMovable = true;
    /**
    ...
    public int getHeaderViewsCount() {
        int headerCount = super.getHeaderViewsCount();
        return mFirstItemMovable ? headerCount : headerCount + 1;
    }

    public boolean isFirstItemMovable() {
        return mFirstItemMovable;
    }

    public void setFirstItemMovable(boolean firstItemMovable) {
        mFirstItemMovable = firstItemMovable;
    }
