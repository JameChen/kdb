...
public class PackageBean implements Serializable{
    ...
    public static class PackageListBean implements Serializable{
         ...
         */
        @Expose
        @SerializedName("CanInstockQty")
        private int CanInstockQty;

        public int getCanInstockQty() {
            return CanInstockQty;
        }

        public void setCanInstockQty(int canInstockQty) {
            CanInstockQty = canInstockQty;
        }
