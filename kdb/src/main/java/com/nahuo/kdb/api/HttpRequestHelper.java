...
import com.nahuo.kdb.api.RequestMethod.UserMethod;
...
public void cancelRequests() {
    ...
    public static class HttpRequest {
        ...
        public void doPost() {
            ...
            String mServer = (mMethod.startsWith("user/") ? HttpUtils.SERVERURL_V4 : HttpUtils.SERVERURL);
            ...
            if (!UserMethod.USER_LOGIN.equals(mMethod) && !UserMethod.USER_CONNECT_LOGIN.equals(mMethod)
                    && !UserMethod.USER_REGISTER.equals(mMethod) && !TextUtils.isEmpty(cookie)) {
        ...
        private void dealResultData(Header[] headers, Object data) {
            ...
            if (UserMethod.USER_REGISTER.equals(mMethod) || UserMethod.USER_LOGIN.equals(mMethod)
            ...
            try {
                ...
                } else if (mConvert2Token != null) {// 解析为list class对象
                    Gson gson = new Gson();
...
//                        ViewHub.showShortToast(mContext, resultData.getMessage());
                        mHttpRequestListener.onRequestExp(mMethod, resultData.getMessage());
                    }
                }
            } catch (Exception e) {
                ...
                e.printStackTrace();
                if (mHttpRequestListener != null) {
                    mHttpRequestListener.onRequestExp(mMethod, e.toString());
                }
            }
        }
