...
import com.nahuo.kdb.common.Const.PasswordExtra;
import com.nahuo.kdb.common.Const.PasswordType;
import com.nahuo.kdb.common.FileUtils;
import com.nahuo.kdb.common.VersionUtils;
import com.nahuo.kdb.controls.WidgetSettingItem;
...
public class SettingActivity extends BaseActivity2 implements OnClickListener {
    ...
    private class ClearTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            gcCountEnd += getFileSize(cacheFile, 0);
            //清除sd cache
            File cacheFile1 = new File(SDCardHelper.getSDCardRootDirectory()+"/kdb/qrcode_cache");
            File cacheFile2 = new File(SDCardHelper.getSDCardRootDirectory()+"/kdb/share");
            File cacheFile3 = new File(SDCardHelper.getSDCardRootDirectory()+"/kdb/share_download");
            File cacheFile4 = new File(SDCardHelper.getSDCardRootDirectory()+"/kdb/tackPhoto_tmp");
            File cacheFile5 = new File(SDCardHelper.getSDCardRootDirectory()+"/kdb/upload_tmp");
